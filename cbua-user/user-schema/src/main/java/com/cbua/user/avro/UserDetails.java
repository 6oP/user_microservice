...
public class UserDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static BinaryMessageDecoder<UserDetails> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<UserDetails>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public UserDetails(java.lang.String firstName, java.lang.String lastName, java.lang.String email) {
   ...
   */
  public static com.cbua.user.avro.UserDetails.Builder newBuilder() {
    return new com.cbua.user.avro.UserDetails.Builder();
  }
   ...
   * @return A new UserDetails RecordBuilder
   */
  public static com.cbua.user.avro.UserDetails.Builder newBuilder(com.cbua.user.avro.UserDetails.Builder other) {
    if (other == null) {
      return new com.cbua.user.avro.UserDetails.Builder();
    } else {
      return new com.cbua.user.avro.UserDetails.Builder(other);
    }
  }
   ...
   * @return A new UserDetails RecordBuilder
   */
  public static com.cbua.user.avro.UserDetails.Builder newBuilder(com.cbua.user.avro.UserDetails other) {
    if (other == null) {
      return new com.cbua.user.avro.UserDetails.Builder();
    } else {
      return new com.cbua.user.avro.UserDetails.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserDetails>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.cbua.user.avro.UserDetails.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.cbua.user.avro.UserDetails other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbua.user.avro.UserDetails.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbua.user.avro.UserDetails.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbua.user.avro.UserDetails.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbua.user.avro.UserDetails.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbua.user.avro.UserDetails.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.cbua.user.avro.UserDetails.Builder clearEmail() {
      email = null;
